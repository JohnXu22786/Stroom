...
extension _ChatComposerAttachmentsExt on ChatComposerWidgetState {
  ...
  ///   buttons. If the user taps either, opens [ExtendedImageEditorPage];
  ///   on save, updates the pending attachment with edited bytes. The
  ///   editor processes the image in place (the page stays open with a
  ///   spinner until the pipeline finishes) and only then pops back with
  ///   the edited bytes.
